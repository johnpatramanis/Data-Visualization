...
for line in vcf:
    if line[0]=='#' and line[1]!='#':
        ...
        for k in population_labels:
            familyname=k.split('_')
            true_labels.append(familyname[0])
...
####################################################################################################################################################
####################################################################################################################################################
#differences with n neighbours
#small nubmer

UMAPPED=umap.UMAP(n_neighbors=5,min_dist=0.01).fit_transform(genotypes)
...
UMAPPED=umap.UMAP(n_neighbors=5,min_dist=0.9).fit_transform(genotypes)
...
#dif min_dist
#small
UMAPPED=umap.UMAP(n_neighbors=50,min_dist=0.9).fit_transform(genotypes)
